...
/* package sf-haskell-0.1.0.0 */
#ifndef VERSION_sf_haskell
#define VERSION_sf_haskell "0.1.0.0"
#endif /* VERSION_sf_haskell */
#ifndef MIN_VERSION_sf_haskell
#define MIN_VERSION_sf_haskell(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_sf_haskell */
...
#define CURRENT_COMPONENT_ID "sf-haskell-0.1.0.0-inplace-sf-haskell"
